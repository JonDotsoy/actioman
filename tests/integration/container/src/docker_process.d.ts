...
export declare class DockerProcess {
  ...
  readonly stdoutSubscriber: Subscriber<Uint8Array>;
  readonly stderrSubscriber: Subscriber<Uint8Array>;
  readonly exited: Promise<ExitedDockerProcess>;
  private readonly verboseState;
  private readonly nothrowState;
  constructor(
    stdout: ReadableStream<Uint8Array>,
    stderr: ReadableStream<Uint8Array>,
    stdoutSubscriber: Subscriber<Uint8Array>,
    stderrSubscriber: Subscriber<Uint8Array>,
    exited: Promise<ExitedDockerProcess>,
    verboseState: Atom<boolean>,
    nothrowState: Atom<boolean>,
  );
  /**
   ...
   */
  waitForLog(match: string, timeout?: number): Promise<this>;
  /**
